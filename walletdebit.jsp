...
if(session.getAttribute("username")==null)
        ...
        String wallet1=(String)session.getAttribute("total");
        int wallet=Integer.parseInt(wallet1);
        //int wallet=2500;
        //int id=1;
        DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                    Date date3 = new Date(); 
                    String sqlDate2 = dateFormat.format(date3); 
                    //out.println(wallet1+uname);
...
String status="debit";
        String url="jdbc:mysql://localhost:3306/users";
            ...
            try
            {
                ...
                RequestDispatcher rd=request.getRequestDispatcher("ticintodb.jsp");  
