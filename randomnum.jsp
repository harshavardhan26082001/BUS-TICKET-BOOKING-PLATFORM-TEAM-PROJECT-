<%-- 
    Document   : randomnum
    Created on : 26 May, 2020, 2:58:19 PM
...
<div class="blurred-box">
  ...
  <div class="user-login-box">
    ...
    <div class="user-name">My Profile</div>
    <form action="randomnum" method="post">
    <input class="user-password" type="text" placeholder="Enter OTP" name="otp" pattern="[0-9]{5,6}" />
