    ...
    <body>
        ...
        String url="jdbc:mysql://localhost:3306/users";
            ...
            try
            {
                ...
                while(rs.next())
                {
                    if(rs.getString("status").equals("not seen"))
                    {%>
                    <h3><a href="chat_area_admin.jsp"><%=rs.getString("user_name")%> :  <%=rs.getString("chat_data")%> at <%=rs.getString("date_time")%></a></h3>
                    <%
                        session.setAttribute("user_id",rs.getString("id"));
                        session.setAttribute("un_chat",rs.getString("user_name"));
                    }
                }
                ...
                /*RequestDispatcher rd=request.getRequestDispatcher("chat_area_admin.jsp");  
