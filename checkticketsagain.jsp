...
int a1=0,k,j;
            try
            {
               ...
               while(rs.next())
               {
                ...
                session.setAttribute("et",rs.getString("end_time"));
                ...
                String[] again=(String[])session.getAttribute("123");
         ...
         DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            ...
            long duration=date3.getTime()-date4.getTime();
             ...
             out.println(diffInMinutes);
                    ...
                    else if(a1==1&&diffInMinutes>180)
                    {
                        
                        response.sendRedirect("tickets1.jsp");
                    }
                    else if(diffInMinutes>180&&a1==0)
                    {
