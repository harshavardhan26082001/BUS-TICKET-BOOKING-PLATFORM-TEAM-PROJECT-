...
<svg version="1.1" id="hand-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 688.5 755.9" style="enable-background:new 0 0 688.5 755.9;" xml:space="preserve">
  <style type="text/css">
    .st0{fill:#F2DCC0;}
    .st1{fill:#61AD86;}
    .st2{fill:#6BBC95;}
...
%>
  ...
  <h1 style="margin-left: 690px;margin-top: -500px;margin-bottom: 500px;">WALLET</h1>
  <div style="margin-top: -400px;margin-left: 100px;">
  <h2>You Can Add Money To Your Wallet:</h2>
  <li>You Can Add Minimum Of RS.1000/-</li>
  <li>You Can Add Maximum Of RS.1,00,000/-</li>
</div>
<div class="amir">
        <form action="debitcard.jsp"  method="post">
            <div class="input-group">
      <input type="text" name="money" placeholder="Enter Money" pattern="[1-9]{1}[0-9]{3,5}" class="w3-button w3-sand" style="margin-left: 200px;margin-top: 100px;height: 45px;">
                <input type="submit" class="w3-button w3-cyan" style="background-color: orange;margin-top: 97px;">
    </div>
        </form>
      </div>
</body>
